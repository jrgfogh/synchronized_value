...
TYPED_TEST(doubly_linked_list_tests, insert_three_elements_in_reverse_and_iterate) {
	TypeParam l;
...
TYPED_TEST(doubly_linked_list_tests, insert_five_elements_out_of_order_and_iterate) {
	TypeParam l;
	auto next = l.insert(l.end(), 1);
	l.insert(next, 2);
